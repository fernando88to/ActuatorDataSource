...
<html>
    ...
    <body>
        ...
        <div id="show-people" class="content scaffold-show" role="main">
            ...
            <f:display bean="people" />
            <g:form resource="${this.people}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.people}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
